...
/**
 * 
 * IValueMap - interface of Map based on code {@link Map}
 *
...
public interface IValueMap extends IValueObject {
	 ...
	 *         value
	 * @throws ClassCastException
	 *             if the value is of an inappropriate type for this map (<a href=
	 *             "{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
	 * @throws NullPointerException
	 ...
	 * @throws UnsupportedOperationException
	 *             if the {@code set} operation is not supported by this map's entry
	 *             set iterator.
	 * @throws ClassCastException
	 *             if the class of a replacement value prevents it from being stored
	 *             in this map
	 * @throws NullPointerException
	 *             if the specified function is null, or the specified replacement
	 *             value is null, and this map does not permit null values
	 * @throws ClassCastException
	 *             if a replacement value is of an inappropriate type for this map
	 *             (<a href=
	 *             "{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
	 * @throws NullPointerException
	 *             if function or a replacement value is null, and this map does not
	 *             permit null keys or values (<a href=
	 *             "{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
	 * @throws IllegalArgumentException
	 *             if some property of a replacement value prevents it from being
	 *             stored in this map (<a href=
	 *             "{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
	 * @throws ConcurrentModificationException
	 *             if an entry is found to be removed during iteration
	 * @since 1.8
	 */
	default void replaceAll(BiFunction<? super String, ? super String, ? extends String> function) {
	 ...
	 * @since 1.8
	 */
	default String putIfAbsent(String key, String value) {
		String v = get(key);
		if (v == null) {
			v = put(key, value);
		}
	 ...
	 *             "{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
	 * @throws ClassCastException
	 *             if the class of a specified key or value prevents it from being
	 *             stored in this map
	 * @throws NullPointerException
	 ...
	 * @since 1.8
	 */
	default String replace(String key, String value) {
		String curValue;
	 ...
	 * <pre>
	 *  {@code
	 * map.computeIfAbsent(key, k -> new Stringalue(f(k)));
	 * }
	 * </pre>
	 *
	 * <p>
	 ...
	 * @throws NullPointerException
	 *             if the specified key is null and this map does not support null
	 ...
	 * @since 1.8
	 */
	default String computeIfAbsent(String key, Function<? super String, ? extends String> mappingFunction) {
	 ...
	 * @since 1.8
	 */
	default String computeIfPresent(String key,
	 ...
	 * @since 1.8
	 */
	default String compute(String key, BiFunction<? super String, ? super String, ? extends String> remappingFunction) {
		Objects.requireNonNull(remappingFunction);
	 ...
	 * {@code
	 * String oldValue = map.get(key);
	 * String newValue = (oldValue == null) ? value :
	 ...
	 * @since 1.8
	 */
	default String merge(String key, String value,
			BiFunction<? super String, ? super String, ? extends String> remappingFunction) {
		Objects.requireNonNull(remappingFunction);
