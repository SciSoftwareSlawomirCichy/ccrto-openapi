...
/**
 * 
 * IValueList - interface based on code {@link List}
 *
...
public interface IValueList extends IValueObject {
	 ...
	 */
	Iterator<CcrtoProperty> iterator();
	 ...
	 */
	<T extends CcrtoProperty> T[] toArray(T[] a);
	 ...
	 * @see #add(Object)
	 */
	boolean addAll(Collection<? extends CcrtoProperty> c);
	 ...
	 */
	boolean addAll(int index, Collection<? extends CcrtoProperty> c);
	 ...
	 * @return <tt>true</tt> if this list changed as a result of the call
	 * @throws UnsupportedOperationException
	 *             if the <tt>removeAll</tt> operation is not supported by this list
	 * @throws ClassCastException
	 ...
	 * @return <tt>true</tt> if this list changed as a result of the call
	 * @throws UnsupportedOperationException
	 *             if the <tt>retainAll</tt> operation is not supported by this list
	 * @throws ClassCastException
	 *             if the class of an element of this list is incompatible with the
	 *             specified collection
	 *             (<a href="Collection.html#optional-restrictions">optional</a>)
	 ...
	 *           <pre>
	 * {@code
	 *     final ListIterator<CcrtoProperty> li = list.listIterator();
	 *     while (li.hasNext()) {
	 ...
	 *             null value and this list does not permit null elements
	 *             (<a href="Collection.html#optional-restrictions">optional</a>)
	 * @since 1.8
	 */
	default void replaceAll(UnaryOperator<CcrtoProperty> operator) {
		Objects.requireNonNull(operator);
		final ListIterator<CcrtoProperty> li = this.listIterator();
		while (li.hasNext()) {
			li.set(operator.apply(li.next()));
		}
	}
	 ...
	 *             operation
	 * @throws IllegalArgumentException
	 *             (<a href="Collection.html#optional-restrictions">optional</a>) if
	 *             the comparator is found to violate the {@link Comparator}
	 *             contract
	 * @since 1.8
	 */
	@SuppressWarnings({ "unchecked", "rawtypes" })
	default void sort(Comparator<? super CcrtoProperty> c) {
		Object[] a = this.toArray();
		Arrays.sort(a, (Comparator) c);
		ListIterator<CcrtoProperty> i = this.listIterator();
		for (Object e : a) {
			i.next();
			i.set((CcrtoProperty) e);
		}
	}
	 ...
	 *             (<tt>index &lt; 0 || index &gt;= size()</tt>)
	 */
	CcrtoProperty set(int index, CcrtoProperty element);
	 ...
	 *             (<tt>index &lt; 0 || index &gt; size()</tt>)
	 */
	void add(int index, CcrtoProperty element);
	 ...
	 *             (<tt>index &lt; 0 || index &gt;= size()</tt>)
	 */
	CcrtoProperty remove(int index);
	 ...
	 */
	ListIterator<CcrtoProperty> listIterator();
	 ...
	 */
	ListIterator<CcrtoProperty> listIterator(int index);
	 ...
	 */
	CcrtoPropertyList subList(int fromIndex, int toIndex);
