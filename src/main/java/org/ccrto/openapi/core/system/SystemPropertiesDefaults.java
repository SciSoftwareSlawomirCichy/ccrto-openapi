...
public class SystemPropertiesDefaults {
	...
	/**
	 * Maksymalna możliwa długość typu String przechowywana w parametrach
	 */
	public static final int MAX_STRING_VALUE_LENGTH = 256;

	/**
	 * Maksymalna możliwa długość typu Text przechowywana w parametrach
	 */
	public static final int MAX_TEXT_VALUE_LENGTH = 4000;
