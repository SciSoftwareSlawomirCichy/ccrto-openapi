...
import org.ccrto.openapi.values.api.IValueURL;
...
public class CcrtoPropertyURL extends CcrtoProperty implements IValueURL {
	...
	public CcrtoPropertyURL(String title, String urlReference) {
		this();
		this.title = title;
		this.urlReference = urlReference;
	}

	public CcrtoPropertyURL(String title, String urlReference, String urlClass) {
		this(title, urlReference);
		this.urlClass = CcrtoUrlClass.getClass(urlClass);
	}

	public CcrtoPropertyURL(String title, String urlReference, CcrtoUrlClass urlClass) {
		this(title, urlReference);
