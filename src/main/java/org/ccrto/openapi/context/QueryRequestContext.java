...
public class QueryRequestContext implements Serializable {
	 ...
	 */
	public QueryRequestContext copy() {
		QueryRequestContext copy = new QueryRequestContext();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof QueryRequestContext)) {
			return false;
		}
		QueryRequestContext other = (QueryRequestContext) obj;
		if (cacheUsage == null) {
